...
window.onload = function(){
    ...
    game.fps = 60;
    game.preload("images/character.png");
    ...
    for(var i = 0; i < 5; i++)
    {
        ...
        bunny.image = game.assets["images/character.png"];
        bunny.realx = 200;
        bunny.realy = 150;
        blueteam.push(bunny);
    }
    ...
    {
        var bunny = new KevinSprite();
        bunny.image = game.assets["images/character2.png"];
        bunny.realx = 200;
        bunny.realy = 150;
    ...
    {
        var bunny = new KevinSprite();
        bunny.image = game.assets["images/tower2.png"];
        bunny.realx = 200;
        bunny.realy = 150;
    ...
    {
        var bunny = new KevinSprite();
        bunny.image = game.assets["images/plus.png"];
        bunny.realx = 200;
        bunny.realy = 150;
    ...
    {
        var bunny = new KevinSprite();
        bunny.image = game.assets["images/minus.png"];
        bunny.realx = 200;
        bunny.realy = 150;
...
socket.on('information', function (data)
{
    ...
    {
        var bunny = new KevinSprite();
        bunny.image = game.assets["images/blueshot.png"];
    ...
    {
        var bunny = new KevinSprite();
        bunny.image = game.assets["images/orangeshot.png"];
